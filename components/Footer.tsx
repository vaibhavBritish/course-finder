...
export default function Footer() {
  return (
    <footer className="bg-slate-50 text-slate-600 pt-20">
      <div className="max-w-7xl mx-auto px-6">
        {/* Top Info Banner */}
        <div className="mb-16 pb-12 text-center md:text-left">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-16 text-sm">
          {/* About */}
          <div>
            <h3 className="text-slate-900 font-bold tracking-widest uppercase mb-6 text-xs border-l-2 border-rose-600 pl-3">About</h3>
          ...
          {/* Popular Subjects */}
          <div>
            <h3 className="text-slate-900 font-bold tracking-widest uppercase mb-6 text-xs border-l-2 border-rose-600 pl-3">Popular Subjects</h3>
            <ul className="space-y-4">
          ...
          {/* Career Guides */}
          <div>
            <h3 className="text-slate-900 font-bold tracking-widest uppercase mb-6 text-xs border-l-2 border-rose-600 pl-3">Career Guides</h3>
            <ul className="space-y-4">
          ...
          {/* Immigration */}
          <div>
            <h3 className="text-slate-900 font-bold tracking-widest uppercase mb-6 text-xs border-l-2 border-rose-600 pl-3">Immigration</h3>
            <ul className="space-y-4">
          ...
          {/* Connect */}
          <div>
            <h3 className="text-slate-900 font-bold tracking-widest uppercase mb-6 text-xs border-l-2 border-rose-600 pl-3">Connect</h3>
            <ul className="space-y-4">
        ...
        {/* Newsletter Section */}
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-8 mb-12 shadow-sm relative overflow-hidden">
          <div className="absolute -right-20 -top-20 w-64 h-64 bg-rose-600/10 rounded-full blur-3xl"></div>
          <div className="relative z-10 flex-1">
            <h3 className="text-2xl font-extrabold text-slate-900 mb-2">Join Our Community</h3>
            <p className="text-slate-500 font-medium">Get info about top courses, career resources and the latest scholarship and funding opportunities.</p>
          </div>
          <div className="relative z-10 w-full md:w-auto">
            <form className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
              <input 
                ...
                className="w-full sm:w-72 bg-slate-50 border border-slate-200 text-slate-900 rounded-xl py-3 px-6 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all placeholder:text-slate-400"
              />
              <button className="bg-rose-600 hover:bg-rose-500 text-white font-bold py-3 px-8 rounded-xl shadow-lg transition-all active:scale-95 whitespace-nowrap">
                Subscribe
              </button>
            </form>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium">
